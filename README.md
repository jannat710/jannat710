...
<p align="center">
  A passionate <strong>Frontend Developer</strong> who loves creating beautiful and user-friendly web apps using <strong>React</strong>, <strong>TailwindCSS</strong>, <strong>TypeScript</strong>, and <strong>Redux Toolkit</strong>.<br>
